...
export const SCREENS = [
  ...
  { id: 'settings', label: 'Event Settings', title: 'Event settings',
    lede: 'Notes, and the hour a day is considered to begin.' },
  { id: 'swap', label: 'Data Transfer', title: 'Event data transfer',
  ...
  { id: 'zexport', label: 'Export Z-Dates', title: 'Export Z-Dates',
